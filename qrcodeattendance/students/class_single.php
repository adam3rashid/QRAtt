...
<!--This file is responible for showing all students in Form 1-->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
        ...
        <table class="table" style="width: 75%; margin-top: 5%; margin-bottom: 32%; float: center;">
          ...
          <tbody>
            ...
            if($conn->connect_error){
                ...
                $sql ="SELECT * FROM students WHERE classgroup = 'form1'";
            ...
            <tr>
              ...
              <td><?php  echo "<a class='btn btn-info' href='view.php?id=" .$row['admissionnumber'] ."'> View </a>";?></td>

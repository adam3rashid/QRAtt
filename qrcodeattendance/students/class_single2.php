...
<!--This file is responsible to show form 3 students-->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <body>
        ...
        <table class="table" style="width: 75%; margin-top: 5%; margin-bottom: 32%; float: center;">
          ...
          <tbody>
            ...
            if($conn->connect_error){
                ...
                $sql ="SELECT * FROM students WHERE classgroup = 'form3'";
            ...
            <tr>
                ...
                <td><?php  echo "<a class='btn btn-info' href='view2.php?id=" .$row['admissionnumber'] ."'> View </a>";?></td>
    ...
    <footer>
      <p>© 2022 Mohammed Hussein & Adam Rashid & Mohamad Rashid</p>
    </footer>
  </body>

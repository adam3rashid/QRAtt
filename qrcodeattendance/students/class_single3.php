...
<!--This file is for showing form 4 students-->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
        ...
        <table class="table" style="width: 75%; margin-top: 5%; margin-bottom: 32%; float: center;">
          ...
          <tbody>
            ...
            if($conn->connect_error){
                ...
                $sql ="SELECT * FROM students WHERE classgroup = 'form4'";
            ...
            <tr>
                ...
                <td><?php  echo "<a class='btn btn-info' href='view3.php?id=" .$row['admissionnumber'] ."'> View </a>";?></td>

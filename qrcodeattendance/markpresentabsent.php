    ...
    <body>
        ...
        <div>
            <center>
                ...
                <table class="table" style="width: 75%; margin-top: 5%; margin-bottom: 20%;  float: center;">
                    <thead>
                        <tr>
                            <th>Class</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo "<a class='btn btn-success' href='mark.php?id=" .$row['admissionnumber'] ."'> In/Out</a>";?></td>
                        </tr>
                        <?php
                        }
                        ?>

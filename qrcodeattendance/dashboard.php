...
<!--file that principal and teacher lands on after loging in-->
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-success">
            ...
            <a href="logout.php" ><button style=" padding: 5px; margin-left: 10%;"  class="btn btn-info my-2 my-sm-0">Logout</button></a>
        </nav>

        <br/><br/>
        <div style="height: 450px; width: 750px; margin: auto; padding-left: 50px; margin-bottom: 60px;" >
            <div class="row">
                <div class="col" style="width: 200px; height: 150px; padding-top: 50px; margin-right: 20px; margin-bottom: 20px; background-color: green;">
                    <center><i class="fa fa-edit" style="font-weight: bold; color: white;"></i></center>
                    <center><a href="registerstudent.php" style="font-weight: bold; color: white;">Register New Student</a></center>
                </div>
                ...
                <div class="col" style="width: 200px; height: 150px; padding-top: 50px; margin-right: 20px; background-color: green;">
                    <center><i class="fa fa-group" style="font-weight: bold; color: white;"></i></center>    
                    <center><a href="users.php" style="font-weight: bold; color: white;">Users</a></center>
                </div>
            </div>

            ...
            <div class="row">
                <div class="col-md-12">
					<div style="border-radius: 5px;padding:10px;background:#fff;" id="divvideo">
               			<p>Attendance Summary <button onclick="Export()" class="btn" style="background-color: green; color: white;">Export</button></p>
			   			<table id="example1" class="table table-bordered">
							...
							<tbody>
								...
								$sql ="SELECT * FROM attendance LEFT JOIN students ON attendance.admissionnumber=students.admissionnumber";
